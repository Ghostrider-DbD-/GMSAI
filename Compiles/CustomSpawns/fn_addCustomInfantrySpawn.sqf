...
[format["<START> addCustomInfantrySpawn: marker pos %1 | shape %2 | size %3",_pos,_shape,_size]] call GMSAI_fnc_log;
private "_m";
...
[format["addCustomInfantrySpawn: marker pos %1 | shape %2 | size %3",_pos,_shape,_size]] call GMSAI_fnc_log;